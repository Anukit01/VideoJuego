...
public class GraficoSeleccion : MonoBehaviour
{
    ...
    void SelectUnits()
    {
        foreach (var unit in SeleccionadorDeUnidad.Instance.unidadesSeleccionadas)
        {
            if (selectionBox.Contains(myCam.WorldToScreenPoint(unit.transform.position)))
            {
                SeleccionadorDeUnidad.Instance.SeleccionDrag(unit);
            }
        }
    }
}
